  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 4; i++) {
      ...
      final animMatrix = Matrix4.identity()
        ...
        ..translate(
          -bounds.center.dx,
          -bounds.center.dy + (1 - progress) * -40,
        );
